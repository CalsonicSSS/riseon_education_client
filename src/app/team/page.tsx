    ...
    <div className='min-h-screen bg-white'>
      ...
      {/* <section className='py-20 bg-riseon-green text-white'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl mb-8 text-white/90 max-w-3xl mx-auto'>Experience the difference that passionate, qualified educators can make in your academic journey.</p>
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            <Link href='/#contact'>
            ...
            <Link href='/services'>
              <Button size='lg' variant='outline' className='border-white text-white hover:bg-white hover:text-riseon-green px-8 py-3'>
